...
const crossChainTransferTool = createTool({
  description: "Initiate a cross-chain USDC transfer using Circle CCTP between supported testnets (sepolia, lineaSepolia, arbitrumSepolia, optimismSepolia)",
  parameters: z.object({
